export default function PrivacyPage() {
  return (
    <main className="page-wrap policy-page">
      ...
      <p>
        Viswas Oils collects customer details needed to create accounts, deliver orders, collect payments, and respond to contact messages.
      </p>
      ...
      <h2>Payments</h2>
      <p>Payments are handled through Razorpay. Viswas Oils stores payment IDs and verification status, not card or UPI credentials.</p>
      <h2>Data Security</h2>
      ...
      <h2>Contact</h2>
      <p>For privacy questions, contact care@viswasoils.test.</p>
    </main>
  );
}
